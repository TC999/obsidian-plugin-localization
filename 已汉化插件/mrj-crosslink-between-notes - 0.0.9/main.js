        ...
        _this.addBacklink = function (files) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        new obsidian.Notice("添加链接 [[" + fileName + "]] to " + succeed.map(function (e) { return e.basename; }).join(','));
                        return [2 /*return*/];
                }
            });
        }); };
...
var FilesModal = /** @class */ (function (_super) {
    ...
    FilesModal.prototype.init = function () {
        ...
        this.setInstructions([
            { command: '↑↓', purpose: '导航' },
            { command: '↵', purpose: '将链接附加到文件' },
            { command: 'esc', purpose: '解除' }
        ]);
...
var CrosslinkSettingsTab = /** @class */ (function (_super) {
    ...
    CrosslinkSettingsTab.prototype.display = function () {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: '插件 "添加指向当前笔记的链接" 设置' });
        new obsidian.Setting(containerEl)
            .setName('模板')
            .setDesc('如何粘贴链接。 `$link` 将被链接本身替换。')
